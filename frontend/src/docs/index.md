...
- **Autonomous Agents**: Multi-agent persona system for specialized tasks (QA, Security, DevOps)
- **Web Agent**: Autonomous browser for web research and interaction
- **Local Codebase RAG**: Chat with your entire codebase intelligently
- **Docker Management**: Auto-generate Dockerfiles and manage containers
- **AutoPilot**: Autonomous workflow planning and execution
- **Mission Control**: TUI Dashboard for real-time monitoring
- **Voice & Vision**: "Conversational Mode" and image understanding
